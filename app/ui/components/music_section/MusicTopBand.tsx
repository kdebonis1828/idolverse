    ...
    <div className="grid grid-cols-2 grid-rows-3 gap-5 w-full mt-12">
        {
            Songs.bandTopTracks.map((bandSongs, i ) => (
                <div key={bandSongs.track} className="flex justify-center  ">
                    ...
                    >
                        ...
                        <h1 className="font-bold text-2xl text-[rgba(217,70,239,0.9)]">{bandSongs.track} </h1>
                        <h4 className="text-lg font-bold text-slate-100/70"> {bandSongs.band} </h4>
                        <h5 className="font-bold mt-10 text-slate-100/70"> {bandSongs.streams} </h5>
                        </div>
