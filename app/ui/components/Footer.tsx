...
export const Footer = () => {
  return (
    <div className="bg-black w-full h-96">
       <div className="flex  justify-center p-10 gap-x-10 md:gap-x-18">
          <motion.a
            href="#" 
            ...
            className="text-4xl md:text-6xl p-5 rounded-xl dark:bg-zinc-500/20 shadow-[0_0_10px_rgba(217,70,239,0.25),0_0_18px_rgba(34,211,238,0.18)] " >
