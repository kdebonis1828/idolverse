...
export const SajaIdolCard = ({idol, demon}: IdolSajaProp) => {
  ...
  return (
    ...
    <Card
      className={` flex relative flex-col mt-10 justify-center items-center  w-45 rounded-xl border py-0 border-pink-600 border-t-red-600-700 border-t-2
        shadow-card-glow bg-center bg-cover lg:scale-125 lg:mt-24
        ...
        <AnimatePresence mode="wait">
            ...
            alt={idol.name}
            className="h-50 scale-130 object-contain"
            />
        </AnimatePresence>
